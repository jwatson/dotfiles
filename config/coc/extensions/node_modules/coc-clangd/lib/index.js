...
const cmds = __importStar(__webpack_require__(2));
const ctx_1 = __webpack_require__(33);
const file_status_1 = __webpack_require__(41);
async function activate(context) {
    ...
    if (!bin) {
        coc_nvim_1.workspace.showMessage(`clangd is not found, you need to install clangd first. https://clangd.github.io/installation.html`, 'error');
        return;
    }
    ...
    const status = new file_status_1.FileStatus();
    context.subscriptions.push(status, coc_nvim_1.commands.registerCommand('clangd.switchSourceHeader', cmds.switchSourceHeader(ctx)), coc_nvim_1.commands.registerCommand('clangd.symbolInfo', cmds.symbolInfo(ctx)), ctx.client.onDidChangeState((e) => {
        var _a;
        if (e.newState === coc_nvim_1.State.Running) {
            (_a = ctx.client) === null || _a === void 0 ? void 0 : _a.onNotification('textDocument/clangd.fileStatus', (fileStatus) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const fs_1 = __webpack_require__(34);
const which_1 = __importDefault(__webpack_require__(35));
const config_1 = __webpack_require__(39);
const semantic_highlighting_1 = __webpack_require__(40);
...
class Ctx {
    ...
    resolveBin() {
        const bin = which_1.default.sync(this.config.path, { nothrow: true });
        if (!bin) {
            return;
        }
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(36)
